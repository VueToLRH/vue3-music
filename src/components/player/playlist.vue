...
export default {
  ...
  setup() {
    const visible = ref(false) // 是否显示播放列表
    const removing = ref(false) // 是否正在移除播放列表中的歌曲
